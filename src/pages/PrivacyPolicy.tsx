    ...
    <div className="min-h-screen py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="mb-10 text-center">
          <h1 className="text-4xl font-bold text-neutral-900 dark:text-neutral-50">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-neutral-800 dark:text-neutral-200">
          <section>
            <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50 mb-2">Overview</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50 mb-2">Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50 mb-2">How We Use Information</h2>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50 mb-2">Sharing of Information</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50 mb-2">Cookies & Analytics</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50 mb-2">Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50 mb-2">Your Choices</h2>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50 mb-2">Third-Party Links</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50 mb-2">Contact Us</h2>
            <p>
